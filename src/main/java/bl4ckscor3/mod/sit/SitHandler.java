                ...
                if (!EntitySit.OCCUPIED.containsKey(p) && e.getHeldItem() == null) {
                    if (b instanceof BlockSlab) {
                        ...
                        && b instanceof blusunrize.immersiveengineering.common.blocks.BlockIESlabs) {
                            ...
                            if (b instanceof com.carpentersblocks.block.BlockCarpentersStairs) {} else
                                if (b instanceof com.carpentersblocks.block.BlockCarpentersSlope) {} else
                                    if (b instanceof com.carpentersblocks.block.BlockCarpentersBlock) {
                                        TileEntity te = w.getTileEntity(event.x, event.y, event.z);
                                        ...
                                        if (te instanceof com.carpentersblocks.tileentity.TEBase) {
                                            ...
                                            if (TE.getData() != com.carpentersblocks.data.Slab.SLAB_Y_NEG) return;
                                        }
                                    } else return;
                        } else return;
